CREATE TABLE FLIGHTS (id int PRIMARY KEY NOT NULL,departure_id varchar(255) REFERENCES AIRPORTS(id),arrival_id varchar(255) REFERENCES AIRPORTS(id),departure_date Date,departure_time Time,arrival_date Date,arrival_time Time,gate varchar(255),terminal int,boarding_begins Time,boarding_ends Time,number_of_first_class_seats int,number_of_business_class_seats int,number_of_economy_seats int,first_cost double,business_cost double,economy_cost double)
